...
def main():
    ...
    source_contracts = {
        ...
        "Message artifact link": ("backend/asterion_api/storage/encrypted_sqlite.py", "artifact_id TEXT"),
        ...
        "Rooms schema": ("backend/asterion_api/storage/encrypted_sqlite.py", "CREATE TABLE IF NOT EXISTS rooms"),
        "Artifacts schema": ("backend/asterion_api/storage/encrypted_sqlite.py", "CREATE TABLE IF NOT EXISTS artifacts"),
        "Agent runs schema": ("backend/asterion_api/storage/encrypted_sqlite.py", "CREATE TABLE IF NOT EXISTS agent_runs"),
        "Flight recorder schema": ("backend/asterion_api/storage/encrypted_sqlite.py", "CREATE TABLE IF NOT EXISTS agent_logs"),
